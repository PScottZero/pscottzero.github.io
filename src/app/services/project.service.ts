...
export class ProjectService {
  ...
  recentProjects = [
    new InfoBlock('Altair 8800 Emulator', PROJ_IMG_DIR + 'altair.jpg', 'February 2020 - Present', GIT_HUB + 'Altair8800'),
    new InfoBlock('Dot Matrix (Game Boy Emulator)', PROJ_IMG_DIR + 'dotmatrix.jpg', 'March 2019 - Present', GIT_HUB + 'DotMatrix'),
